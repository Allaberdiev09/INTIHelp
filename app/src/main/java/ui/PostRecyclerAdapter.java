...
public class PostRecyclerAdapter extends RecyclerView.Adapter<PostRecyclerAdapter.ViewHolder> {
   ...
   private List<Post> journalList;

    public PostRecyclerAdapter(Context context, List<Post> journalList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PostRecyclerAdapter.ViewHolder viewHolder, int position) {

        Post journal = journalList.get(position);
        String imageUrl;
